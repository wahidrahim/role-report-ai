  ...
  try {
    return streamObject({
      ...
      system: `
        ...
        ***RADAR CHART DATA***
        Most important critical technical skills the job requires (languages, frameworks, tools, databases only - no soft skills). Collect minimum 4 skills, maximum 8 skills.
        ...
        ***SKILL AUDIT DATA***
        Quantifiable technical skills or absolute musts only. Exclude general soft skills.
        
        CRITICAL: Each skill appears in ONLY ONE category (verified, transferable, or missing) - no duplicates.

        VERIFIED SKILLS: ONLY list skills that are required by the job description AND are explicitly demonstrated by the candidate.
        ...
        ***FIT SCORE***
        0-100 synthesizing radar chart and skill audit findings. Consider verified vs missing critical skills.

        ***VERDICT***
        Brief score explanation highlighting key strengths and concerns (max 300 chars).
